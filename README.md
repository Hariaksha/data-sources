...
- `catalog/` — one `.md` file per dataset
  ...
  - `governance/` → `fragile-states-index.md`, `state-resilience-index.md`, `corruption-perceptions-index.md`, `global-corruption-barometer.md`, `freedom-house.md`, `democracy-index.md`, `press-freedom-index.md`, `academic-freedom-index.md`, `demspaces.md`, `pandem.md`, `informea.md`, `silencing-science/silencing-science-tracker.md`, `usafacts.md`, `deportation-data-project.md`
...
| Planet Labs (PlanetScope / SkySat / NICFI) | Global (daily); tropics-only for free NICFI basemaps | Pixel/scene | No | [→](catalog/climate/planet-labs.md) |
| Tree Equity Score | US (+ Puerto Rico, USVI); UK version separate | Census block group | No | [→](catalog/climate/tree-equity-score.md) |
| Google Research — Heat Resilience (Rooftop Albedo) | ~50 cities, 14 countries (incl. Indonesia) | Building-level | No | [→](catalog/climate/google-heat-resilience.md) |
...
| Deportation Data Project | US, 2007–present (EOIR back to 1970s) | Individual-level record | No | [→](catalog/governance/deportation-data-project.md) |
